        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-wrap">
                ...
                <h6>
                    ...
                    Apakah anda yakin ingin mengembalikan data posko posyandu dengan nama {{$data->name}} ?
                </h6>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Kembali</button>
                <a class="btn btn-success" href="{{route('sampah.posko.restore',$data->id)}}">Restore</a>
            </div>
        </div>
    </div>
</div>