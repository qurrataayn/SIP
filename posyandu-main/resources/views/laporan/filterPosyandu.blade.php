    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cetak Data Posyandu</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('laporan.posyandu.cetak')}}" target="_blank" enctype="multipart/form-data">
                    @csrf
                    ...
                    @endif
                    <div class="mb-3">
                        <label for="min_usia" class="col-form-label">Usia Awal </label>
                        <input type="number" name="min_usia" class="form-control" placeholder="Usia">
                    </div>
                    <div class="mb-3">
                        <label for="min_usia" class="col-form-label">Usia Akhir </label>
                        <input type="number" name="max_usia" class="form-control" placeholder="Usia">
                    </div>
                    <div class="mb-3">
